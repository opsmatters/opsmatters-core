 ...
 */
public class KeyTransactionWrapper extends EntityWrapper
{
    private KeyTransaction keyTransaction;

    /**
     * Constructor that takes a key transaction.
     * @param keyTransaction The key transaction
     */
    public KeyTransactionWrapper(KeyTransaction keyTransaction)
    {
        super(keyTransaction);
