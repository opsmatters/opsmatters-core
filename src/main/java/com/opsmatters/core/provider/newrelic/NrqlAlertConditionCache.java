 ...
 */
public class NrqlAlertConditionCache extends ResourceCache<NrqlAlertCondition>
{
    private long policyId;
    private Map<Long,NrqlAlertCondition> conditions = new LinkedHashMap<Long,NrqlAlertCondition>();

    /**
     * Constructor that takes a policy id.
     * @param policyId The policy id for the cache
     */
    public NrqlAlertConditionCache(long policyId)
    {
        super("NRQL Alert Conditions");
     ...
     */
    public void add(NrqlAlertCondition condition)
    {
     ...
     */
    public NrqlAlertCondition get(long id)
    {
     ...
     */
    public Collection<NrqlAlertCondition> list()
    {
