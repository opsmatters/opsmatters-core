...
public class PluginsAlertConditionCache extends ResourceCache<PluginsAlertCondition>
{
    ...
    private Map<Long,PluginsAlertCondition> conditions = new LinkedHashMap<Long,PluginsAlertCondition>();

    /**
     * Constructor that takes a policy id.
     * @param policyId The policy id for the cache
     */
    public PluginsAlertConditionCache(long policyId)
    {
     ...
     */
    public void add(PluginsAlertCondition condition)
    {
     ...
     */
    public void add(Collection<PluginsAlertCondition> conditions)
    {
     ...
     */
    public PluginsAlertCondition get(long id)
    {
